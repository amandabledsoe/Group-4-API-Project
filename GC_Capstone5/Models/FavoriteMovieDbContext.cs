...
namespace GC_Capstone5.Models
{
    public partial class FavoriteMovieDbContext : DbContext
    {
        ...
        public FavoriteMovieDbContext(DbContextOptions<FavoriteMovieDbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=FavoriteMovieDb;Trusted_Connection=True;");
            }
        }
